...
function applyBuild130(build) {
    ...
    if (colorEl) selectColor130(colorEl, build.color);
    ...
    if (finishBtn) selectFinish130(finishBtn, build.finish);
...
if (wheelEl) {
    ...
    setTimeout(() => {
        ...
        if (interiorOption) selectInteriorOption130(interiorOption, build.interior);
